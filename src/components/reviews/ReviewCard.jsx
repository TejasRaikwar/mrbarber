    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4 mt-7 pt-6 border-t border-white/5">
                <div className="w-11 h-11 rounded-full bg-gradient-to-br from-yellow-500 to-yellow-600 text-black font-bold flex items-center justify-center shrink-0 shadow-lg">
                    {item.initials}
                </div>
